 ...
 * Based on aiterm's theme-toggle.js
 */
...
(function() {
  ...
  function getCurrentThemeIndex() {
    ...
    if (iconHref.includes('brightness-7')) return 1;     // light
    if (iconHref.includes('brightness-4')) return 2;     // dark
  ...
  function init() {
    ...
    // Observe body attribute changes for theme switches
