...
- **Minimum window size** (900x600) preventing layout breakage
- **Window position memory** via `tauri-plugin-window-state` (persists size, position, maximized state)
- **Auto-collapse sidebars** on resize — right sidebar collapses first, then left, maintaining 500px minimum editor width
